...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--feat_model', type=str, default='resnet50_1024')
        self.parser.add_argument('--cls_model', type=str, default='ABMIL', help='What model architecture to use.')
        ...
        self.parser.add_argument('--feat_dir', type=str)
        self.parser.add_argument('--label_path', type=str)
        ...
        self.parser.add_argument('--batch_size', type=int, default=16, help='Dataloaders batch size.')